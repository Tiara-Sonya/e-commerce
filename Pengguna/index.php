...
<html lang="en">
  ...
  <body>
      ...
      <div class="profil">
        <div class="profil-nav">
          ...
          <div class="nama-profil">
            ...
            <div class="user-profil">User Cherry Coffee</div>
          </div>
          <div class="nama-kontak">
            <img src="image/asset/kontak.png" alt="nama">
            <div class="user-kontak">Kontak User Cherry Coffee</div>
          </div>
          <div class="nama-alamat">
            <img src="image/asset/alamat.png" alt="nama">
            <div class="user-alamat"> Alamat User Cherry Coffee</div>
          </div>
          <div class="logout">
            <a href="#">Log Out</a>
          </div>
    ...
    <!-- PopUp Menu makanan dan minuman -->
