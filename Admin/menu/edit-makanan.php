        ...
        <div class="menu-items">
            ...
            <ul class="nav-links">
                ...
                <div class="item">
                    ...
                    <div class="sub-menu">
                        <a href="Menu-makanan.php" class="sub-item">
                        ...
                        <a href="Menu-minuman.php" class="sub-item" style="margin-top: 10px;">
                            <div class="cild-sub-item">
                                <div class="circle"></div>
                                <div class="circle2"></div>
                                Minuman
                ...
                <div class="item1">
                    ...
                    <div class="sub-menu">
                        <a href="Transaksi-pesanan.php" class="sub-item">
                            <div class="cild-sub-item">
                                <div class="circle"></div>
                                <div class="circle2"></div>
                                Pesanan
                        ...
                        <a href="Transaksi-dalamproses.php" class="sub-item" style="margin-top: 10px;">
                            <div class="cild-sub-item">
                                <div class="circle"></div>
                                <div class="circle2"></div>
                                Dalam Proses
                    ...
                    <div class="tambah2">
                        ...
                        <form action=""  method="post" enctype="multipart/form-data">
                                ...
                                <div class="sub-tambah">
                                    ...
                                    <input type="text" id="harga" name="harga" value="<?= number_format($menu['harga'], 0, ',', '.') ?>" required>
                                </div>
